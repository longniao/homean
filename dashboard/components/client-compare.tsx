...
export function ClientCompare({ id }: { id: string }) {
  ...
  const list = useQuery({ queryKey: ["showings", "contact", id, "all"], queryFn: () => api.showings.listAll({ contactId: id }) });
