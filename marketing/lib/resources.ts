...
export type Resource = {
  ...
  intro: string; sections: { title: string; text: string; bullets?: string[]; example?: string }[];
  download?: string;
};
...
export const resources: Resource[] = [
  {
    ...
    intro: "Use this template after a home tour to preserve the details your buyer may need later. Start with their priorities, separate observations from claims, and finish with unanswered questions. Each step includes a filled fictional example beside the blank prompts. The examples are invented to teach the format, not drawn from a listing, customer report, or completed AI trial.",
    sections: [
      { title: "1. Identify the visit", text: "Property: ____________________    Visit date and time: ____________________", bullets: ["Prepared by: ____________________", "Buyer priorities discussed for this visit: ____________________"], example: "Alder Lane (fictional). Saturday, 2:00 p.m. Prepared by Taylor, a fictional buyer’s agent, for Alex and Sam. Priorities: a quiet workspace, space to cook together, and an entrance comfortable for a visiting parent who finds stairs difficult." },
      { title: "2. Write a short recap", text: "In two or three sentences, describe the most relevant trade-offs for this buyer. Avoid repeating the listing description. If a priority was not assessed, say so.", bullets: ["What stood out: ____________________", "Main trade-off: ____________________", "Not assessed during this visit: ____________________"], example: "The kitchen had room for two people beside the counter, and the rear room was quieter than the front room during the afternoon visit. Three entrance steps remain a concern for visiting family. Workday noise and possible entrance changes have not been assessed." },
      { title: "3. Separate what you know", text: "Use these four prompts to avoid turning an impression or someone else’s statement into an established fact.", bullets: ["Observed during our visit: ____________________", "Buyer reaction or preference: ____________________", "Reported by someone else — identify who: ____________________", "Not yet verified / evidence needed: ____________________"], example: "Observed: three steps at the entrance. Buyer reaction: Sam was concerned about visiting family. Reported claim: the listing representative stated that the kitchen was renovated in 2020. Unknown: the buyers have not reviewed documents supporting that date or the scope of work." },
      { title: "4. Keep room notes relevant", text: "For each useful space, record the room name, an observation, and the related photo or note reference. Leave out repetitive descriptions that do not help the buyer compare homes.", bullets: ["Space / observation / evidence reference: ____________________", "Concern or limitation of the observation: ____________________"], example: "Rear room — quieter than the front room with both doors closed during the 2:00 p.m. visit. Note reference: “rear room,” 00:38 in this invented walkthrough. The note does not establish noise levels during a workday. No actual recording accompanies this teaching example." },
      { title: "5. Agree the next steps", text: "Turn uncertainty into a specific question rather than a confident conclusion.", bullets: ["Question: ____________________", "Who will follow up: ____________________", "When to revisit it: ____________________", "Agent review completed: ____________________"], example: "Agent: request any available kitchen renovation records before the next shortlist conversation. Buyers: discuss whether the entrance steps are acceptable. Revisit the workspace question after a second visit if one can be arranged. Review status for this teaching example: draft; confirmation has not been performed." },
  ...
  },
  {
    ...
    sections: [
      { title: "A three-home comparison example", text: "The filled example above follows one fictional household across Alder Lane, Cedar Court, and Birch Place. Alder offers more kitchen space but three entrance steps; Cedar has no steps on the route used but a tighter kitchen; Birch offers an open layout but no separate workspace. Each visit leaves questions open. The example shows how to plan a next conversation without declaring a winning home." },
