    ...
    <div className="mx-auto max-w-4xl">
      ...
      <form className="mt-9 space-y-6" onSubmit={submit}>
        <section className="panel p-5 sm:p-7">
          <div className="mb-5 flex size-9 items-center justify-center rounded-xl bg-indigo-50 text-sm font-bold text-[#3d5d91]">1</div>
          ...
          <fieldset className="mt-5">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <label className={cn("flex cursor-pointer gap-3 rounded-xl border p-3 transition", propertySelection === "assigned" ? "border-[#3d5d91] bg-indigo-50/60" : "border-stone-200 hover:bg-stone-50")}>
                <input
                  checked={propertySelection === "assigned"}
                  className="mt-1 accent-[#3d5d91]"
              ...
              <label className={cn("flex cursor-pointer gap-3 rounded-xl border p-3 transition", propertySelection === "none" ? "border-[#3d5d91] bg-indigo-50/60" : "border-stone-200 hover:bg-stone-50")}>
                <input
        ...
        <section className="panel p-5 sm:p-7">
          <div className="mb-5 flex size-9 items-center justify-center rounded-xl bg-indigo-50 text-sm font-bold text-[#3d5d91]">2</div>
          ...
          <div
            className={cn(
              ...
              dragging && "border-[#3d5d91] bg-indigo-50",
            )}
            ...
            onDrop={drop}
          >
            <UploadCloud className="mb-4 size-8 text-[#3d5d91]" />
                  ...
                  <div className="flex items-center gap-3 rounded-xl border bg-white p-3" key={`${item.file.name}-${index}`}>
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-stone-100">
                        <div className="h-full bg-[#3d5d91] transition-all" style={{ width: `${item.progress}%` }} />
                      </div>
                    </div>
                    {item.done ? (
        ...
        >
          ...
          <label className="mt-5 flex cursor-pointer items-start gap-3 rounded-xl border border-stone-200 p-4 transition hover:bg-stone-50">
            <input
              ...
              checked={consentAck}
              className="mt-1 size-4 accent-[#3d5d91]"
