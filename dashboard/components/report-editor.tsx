  ...
  return (
    <section className="panel p-4 sm:p-5">
      <div className="mb-4 flex items-center justify-between gap-3">
        <h3 className="font-serif text-xl font-semibold text-[#222329]">{title}</h3>
        {!readOnly && (
      ...
      {bullets.length === 0 ? (
        <p className="rounded-xl bg-[#eceef2] px-4 py-5 text-sm text-[#595e69]">
        ...
        <div className="space-y-3">
          {bullets.map((bullet, index) => {
            ...
            return (
              <article
                className={cn(
                  "group rounded-xl border border-[#dce0e6] bg-[#f7f8fa]/70 p-3",
                ...
                <div className="flex gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2">
                      {sources.map((source) => (
                        <button
                          className="inline-flex max-w-full items-center gap-1 rounded-full border border-[#dce0e6] bg-[#ffffff] px-2 py-1 text-xs font-medium text-[#3d5d91] shadow-sm transition hover:border-[#3d5d91]/30 hover:bg-indigo-50"
                          key={source.id}
          ...
          {observations.length === 0 && emptyEvidenceMessage && (
            <p className="rounded-xl bg-[#eceef2] px-4 py-3 text-sm text-[#595e69]">
              {emptyEvidenceMessage}
            </p>
          )}
        </div>
...
export function ReportEditor({
  ...
  return (
    <div className="space-y-5">
      ...
      {!readOnly && (
        <div className="sticky bottom-4 z-20 flex flex-col gap-3 rounded-2xl border border-[#dce0e6] bg-[#ffffff]/96 p-4 shadow-[0_20px_50px_rgb(34_35_41_/_0.14)] backdrop-blur sm:flex-row sm:items-center">
          <div className="min-w-0 flex-1">
