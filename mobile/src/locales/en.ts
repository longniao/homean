export const en = {
  ...
  home: {
    ...
    deleteBody: 'This permanently deletes your account, workspace, every showing, recording, photo, report and share link, on this phone and on Homean. It cannot be undone.',
    deletePassword: 'Confirm your password',
    deleteConfirm: 'Delete everything',
    deleteWrongPassword: 'That password does not match.',
    deleteOffline: 'Deleting your account needs a connection. Try again when you are online.',
