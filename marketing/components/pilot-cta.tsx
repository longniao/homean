  ...
  return (
    <section className="pilot-section section-shell" id="pilot" aria-labelledby="pilot-title">
      <div className="pilot-grid">
        ...
        <div className="pilot-copy"><p>{content.pilot.description}</p><a className="button button-signal" href={pilotMailto()}>{content.pilot.cta}<span aria-hidden="true">↗</span></a><p className="pilot-note">{content.pilot.note}</p></div>
      </div>
    </section>
  );
}
